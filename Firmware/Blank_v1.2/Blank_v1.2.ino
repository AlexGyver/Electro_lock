...
//-------------------------------НАСТРОЙКИ-----------------------------------
#define lock_type 2          // 0 - сервопривод, 1 - щеколда, 2 - привод автомобильный (в разработке)
...
//--------------ПРИВОД--------------
#define gear_inv 1           // инвертировать привод (1 или 0)
...
#elif lock_type == 2
//-----------------ПРИВОД----------------
#define relay1 7        // пин реле 1 подключен к А3
#define relay2 6        // пин реле 2 подключен к А4
